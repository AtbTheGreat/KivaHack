...
function mapFunction(lenderID) {
  console.log("Made it to the mapFunction")
  lendersite = "http://api.kivaws.org/v1/lenders/" + lenderID + "/loans.json" //URL for lender JSON data
  $.ajax({
    complete: function () {
